...
public class ConcurrentHopscotchHashTable<K, V> implements Map<K,V> {
    ...
    public ConcurrentHopscotchHashTable(final int initialCapacity, final int concurrencyLevel) {
